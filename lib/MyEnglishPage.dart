...
class _MyEnglishPage extends State<MyEnglishPage> {
  ...
  EnglishTask _selectedEngTaskKind = EnglishTask('');
...
//    });
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          const Text('Режим: ', textScaleFactor: 1.3),
                          DropdownButton<String>(
                            value: _selectedEngTaskKind.name == ''? null : _selectedEngTaskKind.name,
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                String kind = newValue.toString();
                                _selectedEngTaskKind = EnglishTask(kind);
                              });
                            },
                            items: engTaskKinds
                                .map<DropdownMenuItem<String>>((EnglishTask value) {
  ...
  List<DropdownMenuItem<EnglishTask>> buildDropDownEngTaskKindItems() {
    List<DropdownMenuItem<EnglishTask>> items = [];
